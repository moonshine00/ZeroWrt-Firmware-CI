...
<div align="center">
  ...
  本项目基于 [VIKINGYFY/OpenWRT-CI](https://github.com/VIKINGYFY/OpenWRT-CI) 开发
  ...
  虚拟算法是一个动态算法，自动分析需要的内核模块

  自研的自动更新算法，将部分软件包更新至最新版本，以体验更前沿的技术
  ...
  Fork 的仓库在编译时不会添加部分内核模块，不会自动更新部分软件包
